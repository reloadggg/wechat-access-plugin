...
1. 删除 `~/.openclaw/extensions/wechat-access`
2. 从 `~/.openclaw/openclaw.json` 删除 `channels.wechat-access`
3. 从 `plugins.allow` 和 `plugins.entries` 删除 `wechat-access`
4. 重新执行 `npm run setup`
